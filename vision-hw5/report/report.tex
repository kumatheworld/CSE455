...
\begin{figure}
  ...
  \begin{subfigure}{0.19\textwidth}
    ...
    \label{fig:3_lr1e-4}
  \end{subfigure}
  \caption{Training results of CoolNet. \subref{fig:3_lr1e2} lr=10, \subref{fig:3_lr1e-1} lr=0.1, \subref{fig:3_lr1e-2} lr=0.01 (same as \ref{fig:2_3_bs4}), \subref{fig:3_lr1e-4} lr=0.0001. For \subref{fig:3_lr1e2}, the training loss was as high as 4.1 throughout the training process, which is so high that it does not show up in the figure.}
  \label{fig:3}
\end{figure}
